...
(function initRealjejuModuleLoader(global) {
  ...
  function preloadCoreApp() {
    ...
    coreLoadPromise = loadScript("app-core", "/js/app-core_6.648.min.js?v=20261071-nearby-next-margin-6180")
      .then(() => loadScript("service-modes", "/js/service-modes_6.648.min.js?v=20261071-nearby-next-margin-6180"))
      .then(() => loadScript("app-start", "/js/app-start_6.648.min.js?v=20261071-nearby-next-margin-6180"))
      .then(() => true)
      .catch((error) => {
  ...
  function preloadPropertyInfo() {
    return loadScript("property-info", "/js/property-info_6.648.min.js?v=20261047-parcel-nearby-map-reuse-6104")
      .then(() => true)
      .catch((error) => {
  ...
  function preloadAppFeatures() {
    return loadScript("app-features", "/js/app-features_6.648.min.js?v=20261071-nearby-next-margin-6180")
      .then(() => true)
      .catch((error) => {
  ...
  function preloadRuntimeTail() {
    return loadScript("runtime-tail", "/js/runtime-tail_6.648.min.js?v=20261071-nearby-next-margin-6180")
      .then(() => {
  ...
  function preloadWorkspace() {
    return preloadCoreApp()
      ...
      .then((featuresLoaded) => {
        ...
        return loadScript("workspace", "/js/workspace-app_6.648.min.js?v=20261071-nearby-next-margin-6180");
      })
      .then(() => {
        workspaceReady = true;

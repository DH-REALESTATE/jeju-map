...
(function initRealjejuModuleLoader(global) {
  ...
  function preloadCoreApp() {
    ...
    coreLoadPromise = loadScript("app-core", "/js/min_app-core_6.706.js?v=20261071-nearby-next-margin-6180")
      .then(() => loadScript("service-modes", "/js/min_service-modes_6.706.js?v=20261071-nearby-next-margin-6180"))
      .then(() => loadScript("app-start", "/js/min_app-start_6.706.js?v=20261071-nearby-next-margin-6180"))
      .then(() => true)
      .catch((error) => {
  ...
  function preloadPropertyInfo() {
    return loadScript("property-info", "/js/min_property-info_6.706.js?v=20261047-parcel-nearby-map-reuse-6104")
      .then(() => true)
      .catch((error) => {
  ...
  function preloadAppFeatures() {
    return loadScript("app-features", "/js/min_app-features_6.706.js?v=20261071-nearby-next-margin-6180")
      .then(() => true)
      .catch((error) => {
  ...
  function preloadRuntimeTail() {
    return loadScript("runtime-tail", "/js/min_runtime-tail_6.706.js?v=20261071-nearby-next-margin-6180")
      .then(() => {
  ...
  function preloadWorkspace() {
    return preloadCoreApp()
      ...
      .then((featuresLoaded) => {
        ...
        return loadScript("workspace", "/js/min_workspace-app_6.706.js?v=20261071-nearby-next-margin-6180");
      })
      .then(() => {
        workspaceReady = true;

...
const LIFE_SAFETY_GRID_URL = "life_safety_grid_nohyeong_yeondong.json";
...
{
	if (!Array.isArray(cell) || cell.length < 4 || !bounds) return false;
...
{
	const score = Number(Array.isArray(cell) ? cell[4] : 0);
